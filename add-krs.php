    ...
    <div class="container text-dark mt-4">
      <form action="load-krs.php" method="POST">
        <div class="mb-3 row">
          ...
          <div class="col-sm-5">
            <input value="<?php echo $id ?>" type="text" class="form-control shadow-sm bg-body-secondary rounded" id="inputId" name="inputId" placeholder="Ditentukan secara otomatis" <?php if ($id == '') {echo "disabled";}; ?> >
          </div>
        </div>
        ...
        <div class="mb-3 row">
          ...
          <div class="col-sm-5">
            <input required value="<?php echo $matakuliah_kodemk ?>" type="text" class="form-control shadow-sm bg-light rounded" id="inputKdMK" name="inputKdMK" placeholder="Exp: MK01">
          </div>
        </div>
