  ...
  <div class="container mt-5 pt-4">
    ...
    <div class="container text-dark mt-5">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          <input required type="text" class="form-control shadow-sm bg-light rounded" id="inputKdMk" name="inputKdMk" placeholder="Exp: MK01" value="<?php echo $kodeMk ?>">
        </div>
      </div>
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-5">
          <input required type="text" class="form-control shadow-sm bg-light rounded" id="inputSks" name="inputSks" placeholder="Exp: 3" value="<?php echo $sks ?>">
        </div>
      </div>
