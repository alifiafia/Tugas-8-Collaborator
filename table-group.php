  ...
  <nav class="navbar bg-body-tertiary mb-5 shadow fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#" style="font-size : 1.1em;">
          <img src="img/TEMAFOR.png" alt="logo" style="width: 2.3em; margin-right: 0.5em;">
          <strong class="mt-5">TUGAS 7 - CRUD</strong>
        </a>
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item">
          <a class="nav-link active bg-secondary" aria-current="page" href="#">Data Kuliah</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container mt-5 pt-4">
    <figure class="text-dark">
      <blockquote class="blockquote">
        <h1 class="text-info-emphasis mt-xxl-4">Tabel Mahasiswa</h1>
      </blockquote>
    ...
    <table class="table table-hover mt-3 mb-5 table-striped">
      ...
      <tbody class="table-group-divider">
        ...
        <tr>
          ...
          <td>
            <a type="button" class="btn btn-outline-secondary active" href="add-mhs.php?ubah=<?php echo $result['npm'];?>"><i class="bi bi-pencil"></i></a>
    ...
    <table class="table table-hover mt-3 mb-5 table-striped">
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            <a type="button" class="btn btn-outline-secondary active" href="add-mk.php?ubah=<?php echo $result['kodemk'];?>"><i class="bi bi-pencil"></i></a>
    ...
    <table class="table table-hover mt-3 table-striped">
      ...
      <?php
        ...
        <tr>
          ...
          <td>
            <a type="button" class="btn btn-outline-secondary active" href="add-krs.php?ubah=<?php echo $result['id'];?>"><i class="bi bi-pencil"></i> </a>
